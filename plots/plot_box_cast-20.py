...
for run in ['cast-20.run-ConvDR-1000.txt','cast-20.run-QuReTeC-QA-bm25-1000.txt','cast-20.run-T5-QA-bm25-1000.txt','cast-20.run-manual-bm25-1000.txt']:
    font = {'family' : 'normal',
        'size'   : 18}
