...
import json
import torch
from supervisedQPP.qppBERTPL.dataset import Dataset, collate_fn
from supervisedQPP.qppBERTPL.model import qppBERTPL
from supervisedQPP.qppBERTPL.driver import Driver
...
if __name__ == '__main__':
    ...
    parser.add_argument("--name", type=str, default='qppBERTPL')
    ...
    if args.warm_up_path is not None:
        args.setup = f"{args.dataset_name}.{args.retriever}.{args.query_type}-{args.name}-classification-warm-up"
    else:
        args.setup = f"{args.dataset_name}.{args.retriever}.{args.query_type}-{args.name}-classification"
